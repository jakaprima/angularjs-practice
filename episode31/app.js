...
function ShoppingListDirective() {
  var ddo = {
    ...
    Correct 
// Correct. The link function is called with preset arguments, so you can't directly inject anything into the link function.
...
function ShoppingListDirectiveLink(scope, element, attrs, controller) {
  ...
  console.log("Controller instance is: ", controller); //shoppinglistdirectivecontroller
  console.log("Element is: ", element); //element adalah yang ter parent dari directive
